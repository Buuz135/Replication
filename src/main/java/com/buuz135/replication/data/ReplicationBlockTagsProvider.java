...
public class ReplicationBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(TagUtil.getBlockTag(new ResourceLocation("c", "storage_blocks/replica"))).add(ReplicationRegistry.Blocks.REPLICA_BLOCK.get());
        this.tag(TagUtil.getBlockTag(new ResourceLocation("c", "storage_blocks/raw_replica"))).add(ReplicationRegistry.Blocks.RAW_REPLICA_BLOCK.get());
        ...
        this.tag(TagUtil.getBlockTag(new ResourceLocation("c", "ores/replica"))).add(ReplicationRegistry.Blocks.DEEPSLATE_REPLICA_ORE.get());
    }
}
