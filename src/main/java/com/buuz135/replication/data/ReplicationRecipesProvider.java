...
public class ReplicationRecipesProvider extends RecipeProvider {
    ...
    public void buildRecipes(RecipeOutput consumer) {
        ...
        TitaniumShapedRecipeBuilder.shapedRecipe(ReplicationRegistry.Items.MEMORY_CHIP.get())
                ...
                .save(consumer);
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(ReplicationRegistry.Items.RAW_REPLICA.get()),  RecipeCategory.MISC,ReplicationRegistry.Items.REPLICA_INGOT.get(), 0.35F, 200).save(consumer);
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ReplicationRegistry.Items.RAW_REPLICA.get()),  RecipeCategory.MISC,ReplicationRegistry.Items.REPLICA_INGOT.get(), 0.35F, 100).save(consumer);
    }
}
