...
public class ReplicationItemTagsProvider extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.copy(TagUtil.getBlockTag(new ResourceLocation("forge", "storage_blocks/replica")), TagUtil.getItemTag(new ResourceLocation("forge", "storage_blocks/replica")));
        this.copy(TagUtil.getBlockTag(new ResourceLocation("forge", "storage_blocks/raw_replica")), TagUtil.getItemTag(new ResourceLocation("forge", "storage_blocks/raw_replica")));
        this.copy(Tags.Blocks.ORES, Tags.Items.ORES);
        this.copy(Tags.Blocks.ORES_IN_GROUND_DEEPSLATE, Tags.Items.ORES_IN_GROUND_DEEPSLATE);
        this.copy(TagUtil.getBlockTag(new ResourceLocation("forge", "ores/replica")), TagUtil.getItemTag(new ResourceLocation("forge", "ores/replica")));

        this.tag(Tags.Items.INGOTS).add(ReplicationRegistry.Items.REPLICA_INGOT.get());
        this.tag(TagUtil.getItemTag(new ResourceLocation("forge", "ingots/replica"))).add(ReplicationRegistry.Items.REPLICA_INGOT.get());
        this.tag(Tags.Items.RAW_MATERIALS).add(ReplicationRegistry.Items.RAW_REPLICA.get());
        this.tag(TagUtil.getItemTag(new ResourceLocation("forge", "raw_materials/replica"))).add(ReplicationRegistry.Items.RAW_REPLICA.get());
    }
}
