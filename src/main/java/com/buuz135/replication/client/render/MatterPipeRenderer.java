...
public class MatterPipeRenderer<T extends MatterPipeBlockEntity> implements BlockEntityRenderer<T> {
    ...
    protected RenderType renderType() {
        return RenderType.create("end_portal", DefaultVertexFormat.POSITION, VertexFormat.Mode.QUADS, 1, false, false,
                RenderType.CompositeState.builder()
                        .setShaderState(new RenderStateShard.ShaderStateShard(GameRenderer::getRendertypeEndGatewayShader))
                        .setTextureState(RenderStateShard.MultiTextureStateShard.builder().add(new ResourceLocation("textures/block/dirt.png"), false, false).add(new ResourceLocation("textures/block/dirt.png"), false, false).build())
